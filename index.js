...
module.exports = plugin(function ({ addComponents }) {
    const newComponents = {
        ...
        // btn-basic
        '.btn-basic': {
            '@apply font-semibold p-2.5 rounded-lg w-fit border-[2.5px] border-[#111005] bg-[#111005] text-[#FFFFFF] hover:scale-[1.01] hover:opacity-95': {},
        },

        // btn-basic-outline
        '.btn-basic-outline': {
            '@apply font-semibold p-2.5 rounded-lg w-fit border-[2.5px] border-[#111005] hover:scale-[1.01] hover:bg-[#FAFAFA]': {},
        },

        // btn-neo
        '.btn-neo': {
            '@apply font-semibold p-2.5 w-fit border-[2.5px] border-[#111005] shadow-[4px_4px_0_0_rgba(17,16,5,1)] hover:scale-[1.01] hover:bg-[#FEA6F6] hover:text-white': {},
        },

        // btn-glow
        '.btn-glow': {
            '@apply font-semibold text-white bg-[#111005] border-[2.5px] border-[#111005] p-2.5 rounded-lg hover:scale-[1.01] hover:opacity-95 w-fit shadow-[0_2px_15px_rgba(255,255,0,0.5),_0_4px_30px_rgba(255,0,255,0.5)]': {},
        },
        ...
        '.select-profiles-button': {
            '@apply flex items-center justify-between bg-transparent p-2.5 border-2 rounded-lg w-full': {},
        },
        '.select-profiles-arrow': {
            '@apply ml-2 text-gray-500': {},
        },
        '.select-profiles-dropdown': {
            '@apply absolute w-full bg-transparent border-2 mt-1 hidden z-10 rounded-lg': {},
        },
